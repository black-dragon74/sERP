            ...
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" action="{{ (Request::has('redirect')) ? route('post_login').'?redirect='.request('redirect') : route('post_login') }}" method="post">
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" name="username" type="text" placeholder="Username or E-mail" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                    ...
                    <div class="form-group">
                        <div class="d-flex no-block align-items-center">
                            ...
                            <div class="ml-auto">
                                <a href="javascript:void(0)" id="to-recover" class="text-muted"><i class="fa fa-lock m-r-5"></i> Forgot pass?</a>
                            </div>
                        </div>
                    </div>
